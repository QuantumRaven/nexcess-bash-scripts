...
# Delay - For when customers wait extended periods of time without a response.
delays() {
...
# Menu for the prompt
email-response {
options=$(whiptail --title "Email Responses" --menu "Which email response do you wish to provide?" 25 200 0 \
  ...
  "Information request -" "Start time, replication steps, etc." \
